...
def register() -> tuple[Response, int]:
    ...
    # Създаваме правилния тип потребител според ролята
    ...
    # Използваме set_password() за хеширане
...
def login() -> tuple[Response, int]:
    ...
    # Използваме login() метода от RegisteredUser
...
def get_profile() -> tuple[Response, int]:
    ...
    Очаква header: X-User-ID (временно решение, после ще е JWT)
    """
