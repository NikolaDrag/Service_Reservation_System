...
class RegisteredUser(Guest, db.Model):
    ...
    def create_reservation(self, service_id: int, reservation_date: datetime,
                          ...
                          problem_image_url: Optional[str] = None) -> Reservation:
        """
        ...
        Параметри:
            ...
            notes: Описание на проблема (незадължително)
            problem_image_url: URL на снимка на проблема (незадължително)
        ...
        reservation = Reservation(
            ...
            notes=notes,                            # описание на проблема
